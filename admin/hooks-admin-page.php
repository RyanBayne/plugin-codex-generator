...
class PCG_Admin_Page_Hooks {

	/* @var string $hook_suffix holds plugin page identifier*/
	static $hook_suffix;

	/* @var Plugin_Codex_Generator_Hooks_Table $table */
	static $table;
	...
	static function admin_menu() {
		self::$hook_suffix = add_submenu_page( 'edit.php?post_type=pcg_function', __('Hooks', 'plugincodexgen'), __('Hooks', 'plugincodexgen'), 'manage_options', 'plugincodexgen-hooks', array(__CLASS__, 'page'));
	}
	...
	static function page() {
		...
		<div class="wrap"><?php
			...
			<form id="functions" method="get" action="">
				<input type="hidden" name="page" value="plugincodexgen-hooks" />
